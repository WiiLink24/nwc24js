...
exports.unscrambleId = function(wiiNumber) {
...
exports.loadWiiNumber = function(wiiNumber) {
    const unscrambled = exports.unscrambleId(wiiNumber);
...
exports.isValidWiiNumber = function(numberString) {
    ...
    const loadedWiiNumber = exports.loadWiiNumber(wiiNumber);
